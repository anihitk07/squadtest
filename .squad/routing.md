...
|-----------|----------|----------|
| Architecture and scope | Ripley | API boundaries, state/data contracts, trade-offs |
| Frontend UI (React) | Vasquez | Order list UI, detail panel, interaction behavior |
| Backend/API (Node.js) | Bishop | REST endpoints, data access layer, SQLite queries |
| Testing and quality | Hicks | Unit/integration tests, edge cases, regression checks |
